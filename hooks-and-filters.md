...
| [`eventkoi_default_calendar_color`](#eventkoi_default_calendar_color) _f_ | [`eventkoi_loop_default_window_seconds`](#eventkoi_loop_default_window_seconds) _f_ |
| [`eventkoi_divi_event_options_limit`](#eventkoi_divi_event_options_limit) _f_ | [`eventkoi_low_stock_threshold`](#eventkoi_low_stock_threshold) _f_ |
| [`eventkoi_event_posts_migrated`](#eventkoi_event_posts_migrated) _a_ | [`eventkoi_max_recurrence_iterations`](#eventkoi_max_recurrence_iterations) _f_ |
| [`eventkoi_event_series_template_args`](#eventkoi_event_series_template_args) _f_ | [`eventkoi_max_upload_size_mb`](#eventkoi_max_upload_size_mb) _f_ |
| [`eventkoi_event_template_args`](#eventkoi_event_template_args) _f_ | [`eventkoi_pre_setting_value`](#eventkoi_pre_setting_value) _f_ |
| [`eventkoi_field_date_format`](#eventkoi_field_date_format) _f_ | [`eventkoi_pre_update_calendar_meta`](#eventkoi_pre_update_calendar_meta) _f_ |
| [`eventkoi_frontend_params`](#eventkoi_frontend_params) _f_ | [`eventkoi_pre_update_event_meta`](#eventkoi_pre_update_event_meta) _f_ |
| [`eventkoi_get_calendar_color`](#eventkoi_get_calendar_color) _f_ | [`eventkoi_prepare_raw_db_data`](#eventkoi_prepare_raw_db_data) _f_ |
| [`eventkoi_get_calendar_content`](#eventkoi_get_calendar_content) _f_ | [`eventkoi_qr_checkin_capability`](#eventkoi_qr_checkin_capability) _f_ |
| [`eventkoi_get_calendar_count`](#eventkoi_get_calendar_count) _f_ | [`eventkoi_raw_client_ip`](#eventkoi_raw_client_ip) _f_ |
| [`eventkoi_get_calendar_day_start_time`](#eventkoi_get_calendar_day_start_time) _f_ | [`eventkoi_refund_email_subject`](#eventkoi_refund_email_subject) _f_ |
| [`eventkoi_get_calendar_default_month`](#eventkoi_get_calendar_default_month) _f_ | [`eventkoi_refund_email_tags`](#eventkoi_refund_email_tags) _f_ |
| [`eventkoi_get_calendar_default_year`](#eventkoi_get_calendar_default_year) _f_ | [`eventkoi_refund_email_template`](#eventkoi_refund_email_template) _f_ |
| [`eventkoi_get_calendar_display`](#eventkoi_get_calendar_display) _f_ | [`eventkoi_register_post_type`](#eventkoi_register_post_type) _a_ |
| [`eventkoi_get_calendar_id`](#eventkoi_get_calendar_id) _f_ | [`eventkoi_register_rewrites`](#eventkoi_register_rewrites) _a_ |
| [`eventkoi_get_calendar_list_date_end`](#eventkoi_get_calendar_list_date_end) _f_ | [`eventkoi_register_taxonomy`](#eventkoi_register_taxonomy) _a_ |
| [`eventkoi_get_calendar_list_date_start`](#eventkoi_get_calendar_list_date_start) _f_ | [`eventkoi_rendered_custom_field`](#eventkoi_rendered_custom_field) _f_ |
| [`eventkoi_get_calendar_list_expand_instances`](#eventkoi_get_calendar_list_expand_instances) _f_ | [`eventkoi_rendered_custom_field_group`](#eventkoi_rendered_custom_field_group) _f_ |
| [`eventkoi_get_calendar_list_load_mode`](#eventkoi_get_calendar_list_load_mode) _f_ | [`eventkoi_rendered_custom_fields`](#eventkoi_rendered_custom_fields) _f_ |
| [`eventkoi_get_calendar_list_max_results`](#eventkoi_get_calendar_list_max_results) _f_ | [`eventkoi_rendered_event_calendar`](#eventkoi_rendered_event_calendar) _f_ |
| [`eventkoi_get_calendar_list_order`](#eventkoi_get_calendar_list_order) _f_ | [`eventkoi_rendered_event_calendar_url`](#eventkoi_rendered_event_calendar_url) _f_ |
| [`eventkoi_get_calendar_list_orderby`](#eventkoi_get_calendar_list_orderby) _f_ | [`eventkoi_rendered_event_capacity`](#eventkoi_rendered_event_capacity) _f_ |
| [`eventkoi_get_calendar_list_per_page`](#eventkoi_get_calendar_list_per_page) _f_ | [`eventkoi_rendered_event_capacity_remaining`](#eventkoi_rendered_event_capacity_remaining) _f_ |
| [`eventkoi_get_calendar_meta`](#eventkoi_get_calendar_meta) _f_ | [`eventkoi_rendered_event_capacity_sold`](#eventkoi_rendered_event_capacity_sold) _f_ |
| [`eventkoi_get_calendar_name`](#eventkoi_get_calendar_name) _f_ | [`eventkoi_rendered_event_date`](#eventkoi_rendered_event_date) _f_ |
| [`eventkoi_get_calendar_shortcode`](#eventkoi_get_calendar_shortcode) _f_ | [`eventkoi_rendered_event_date_day`](#eventkoi_rendered_event_date_day) _f_ |
| [`eventkoi_get_calendar_slug`](#eventkoi_get_calendar_slug) _f_ | [`eventkoi_rendered_event_date_day_name`](#eventkoi_rendered_event_date_day_name) _f_ |
| [`eventkoi_get_calendar_startday`](#eventkoi_get_calendar_startday) _f_ | [`eventkoi_rendered_event_date_iso`](#eventkoi_rendered_event_date_iso) _f_ |
| [`eventkoi_get_calendar_timeframe`](#eventkoi_get_calendar_timeframe) _f_ | [`eventkoi_rendered_event_date_month`](#eventkoi_rendered_event_date_month) _f_ |
| [`eventkoi_get_calendar_url`](#eventkoi_get_calendar_url) _f_ | [`eventkoi_rendered_event_date_month_short`](#eventkoi_rendered_event_date_month_short) _f_ |
| [`eventkoi_get_content`](#eventkoi_get_content) _f_ | [`eventkoi_rendered_event_date_year`](#eventkoi_rendered_event_date_year) _f_ |
| [`eventkoi_get_custom_fields`](#eventkoi_get_custom_fields) _f_ | [`eventkoi_rendered_event_datetime`](#eventkoi_rendered_event_datetime) _f_ |
| [`eventkoi_get_custom_fields_layout`](#eventkoi_get_custom_fields_layout) _f_ | [`eventkoi_rendered_event_datetime_with_summary`](#eventkoi_rendered_event_datetime_with_summary) _f_ |
| [`eventkoi_get_custom_fields_state`](#eventkoi_get_custom_fields_state) _f_ | [`eventkoi_rendered_event_details`](#eventkoi_rendered_event_details) _f_ |
| [`eventkoi_get_default_date_format`](#eventkoi_get_default_date_format) _f_ | [`eventkoi_rendered_event_image_url`](#eventkoi_rendered_event_image_url) _f_ |
| [`eventkoi_get_default_event_template`](#eventkoi_get_default_event_template) _f_ | [`eventkoi_rendered_event_location`](#eventkoi_rendered_event_location) _f_ |
| [`eventkoi_get_default_template`](#eventkoi_get_default_template) _f_ | [`eventkoi_rendered_event_low_stock`](#eventkoi_rendered_event_low_stock) _f_ |
| [`eventkoi_get_end_date_g`](#eventkoi_get_end_date_g) _f_ | [`eventkoi_rendered_event_rsvp`](#eventkoi_rendered_event_rsvp) _f_ |
| [`eventkoi_get_event_attendance_mode`](#eventkoi_get_event_attendance_mode) _f_ | [`eventkoi_rendered_event_rsvp_capacity`](#eventkoi_rendered_event_rsvp_capacity) _f_ |
| [`eventkoi_get_event_calendar`](#eventkoi_get_event_calendar) _f_ | [`eventkoi_rendered_event_rsvp_full`](#eventkoi_rendered_event_rsvp_full) _f_ |
| [`eventkoi_get_event_core_status`](#eventkoi_get_event_core_status) _f_ | [`eventkoi_rendered_event_rsvp_going`](#eventkoi_rendered_event_rsvp_going) _f_ |
| [`eventkoi_get_event_counts`](#eventkoi_get_event_counts) _f_ | [`eventkoi_rendered_event_rsvp_remaining`](#eventkoi_rendered_event_rsvp_remaining) _f_ |
| [`eventkoi_get_event_days`](#eventkoi_get_event_days) _f_ | [`eventkoi_rendered_event_sales_end`](#eventkoi_rendered_event_sales_end) _f_ |
| [`eventkoi_get_event_description`](#eventkoi_get_event_description) _f_ | [`eventkoi_rendered_event_sales_start`](#eventkoi_rendered_event_sales_start) _f_ |
| [`eventkoi_get_event_dynamic_tags`](#eventkoi_get_event_dynamic_tags) _f_ | [`eventkoi_rendered_event_sold_out`](#eventkoi_rendered_event_sold_out) _f_ |
| [`eventkoi_get_event_embed_gmap`](#eventkoi_get_event_embed_gmap) _f_ | [`eventkoi_rendered_event_ticket_count`](#eventkoi_rendered_event_ticket_count) _f_ |
| [`eventkoi_get_event_end_date_iso`](#eventkoi_get_event_end_date_iso) _f_ | [`eventkoi_rendered_event_ticket_price_from`](#eventkoi_rendered_event_ticket_price_from) _f_ |
| [`eventkoi_get_event_end_date_raw`](#eventkoi_get_event_end_date_raw) _f_ | [`eventkoi_rendered_event_ticket_price_range`](#eventkoi_rendered_event_ticket_price_range) _f_ |
| [`eventkoi_get_event_gmap_link`](#eventkoi_get_event_gmap_link) _f_ | [`eventkoi_rendered_event_ticket_price_to`](#eventkoi_rendered_event_ticket_price_to) _f_ |
| [`eventkoi_get_event_ical`](#eventkoi_get_event_ical) _f_ | [`eventkoi_rendered_event_ticket_summary`](#eventkoi_rendered_event_ticket_summary) _f_ |
| [`eventkoi_get_event_id`](#eventkoi_get_event_id) _f_ | [`eventkoi_rendered_event_tickets`](#eventkoi_rendered_event_tickets) _f_ |
| [`eventkoi_get_event_image`](#eventkoi_get_event_image) _f_ | [`eventkoi_rendered_event_time`](#eventkoi_rendered_event_time) _f_ |
| [`eventkoi_get_event_image_id`](#eventkoi_get_event_image_id) _f_ | [`eventkoi_rendered_event_timezone`](#eventkoi_rendered_event_timezone) _f_ |
| [`eventkoi_get_event_image_thumb`](#eventkoi_get_event_image_thumb) _f_ | [`eventkoi_rendered_event_title`](#eventkoi_rendered_event_title) _f_ |
| [`eventkoi_get_event_latitude`](#eventkoi_get_event_latitude) _f_ | [`eventkoi_rendered_event_type`](#eventkoi_rendered_event_type) _f_ |
| [`eventkoi_get_event_location`](#eventkoi_get_event_location) _f_ | [`eventkoi_rendered_meta_for_`](#eventkoi_rendered_meta_for_) _f_ |
| [`eventkoi_get_event_locations`](#eventkoi_get_event_locations) _f_ | [`eventkoi_rendered_tickets_terms_conditions`](#eventkoi_rendered_tickets_terms_conditions) _f_ |
| [`eventkoi_get_event_longitude`](#eventkoi_get_event_longitude) _f_ | [`eventkoi_rsvp_email_subject`](#eventkoi_rsvp_email_subject) _f_ |
| [`eventkoi_get_event_meta`](#eventkoi_get_event_meta) _f_ | [`eventkoi_rsvp_email_tags`](#eventkoi_rsvp_email_tags) _f_ |
| [`eventkoi_get_event_post_status`](#eventkoi_get_event_post_status) _f_ | [`eventkoi_rsvp_email_template`](#eventkoi_rsvp_email_template) _f_ |
| [`eventkoi_get_event_recurrence_overrides`](#eventkoi_get_event_recurrence_overrides) _f_ | [`eventkoi_rsvp_fields`](#eventkoi_rsvp_fields) _f_ |
| [`eventkoi_get_event_recurrence_rules`](#eventkoi_get_event_recurrence_rules) _f_ | [`eventkoi_rsvp_payload`](#eventkoi_rsvp_payload) _f_ |
| [`eventkoi_get_event_rsvp_allow_edit`](#eventkoi_get_event_rsvp_allow_edit) _f_ | [`eventkoi_rsvp_qr_code`](#eventkoi_rsvp_qr_code) _f_ |
| [`eventkoi_get_event_rsvp_allow_guests`](#eventkoi_get_event_rsvp_allow_guests) _f_ | [`eventkoi_rsvp_qr_url`](#eventkoi_rsvp_qr_url) _f_ |
| [`eventkoi_get_event_rsvp_auto_account`](#eventkoi_get_event_rsvp_auto_account) _f_ | [`eventkoi_rsvp_show_name_field`](#eventkoi_rsvp_show_name_field) _f_ |
| [`eventkoi_get_event_rsvp_capacity`](#eventkoi_get_event_rsvp_capacity) _f_ | [`eventkoi_set_settings`](#eventkoi_set_settings) _f_ |
| [`eventkoi_get_event_rsvp_enabled`](#eventkoi_get_event_rsvp_enabled) _f_ | [`eventkoi_single_calendar_template`](#eventkoi_single_calendar_template) _a_ |
| [`eventkoi_get_event_rsvp_max_guests`](#eventkoi_get_event_rsvp_max_guests) _f_ | [`eventkoi_single_event_template`](#eventkoi_single_event_template) _a_ |
| [`eventkoi_get_event_rsvp_sale_end`](#eventkoi_get_event_rsvp_sale_end) _f_ | [`eventkoi_taxonomy_objects_event_cal`](#eventkoi_taxonomy_objects_event_cal) _f_ |
| [`eventkoi_get_event_rsvp_sale_start`](#eventkoi_get_event_rsvp_sale_start) _f_ | [`eventkoi_ticket_email_subject`](#eventkoi_ticket_email_subject) _f_ |
| [`eventkoi_get_event_rsvp_show_remaining`](#eventkoi_get_event_rsvp_show_remaining) _f_ | [`eventkoi_ticket_email_tags`](#eventkoi_ticket_email_tags) _f_ |
| [`eventkoi_get_event_schema`](#eventkoi_get_event_schema) _f_ | [`eventkoi_ticket_email_template`](#eventkoi_ticket_email_template) _f_ |
| [`eventkoi_get_event_series_template`](#eventkoi_get_event_series_template) _f_ | [`eventkoi_ticket_qr_url`](#eventkoi_ticket_qr_url) _f_ |
