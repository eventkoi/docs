...
Inventory of every action and filter exposed by EventKoi Pro and Lite. Each entry includes a short description, when the hook fires, the full PHP signature, and the source file where it's declared.

**205 hooks total** — 179 filters and 26 actions. 178 fire in both plugins, 27 are Pro-only, 0 Lite-only.

> **Availability** above each entry: *Pro + Lite* fires in both, *Pro only* and *Lite only* fire in just one. **File** is the canonical declaration; some hooks fire from multiple call sites.

## Topics

- [Events](#events) — 85 hooks (80 filters, 5 actions)
- [Calendars](#calendars) — 32 hooks (27 filters, 5 actions)
- [RSVPs](#rsvps) — 19 hooks (19 filters, 0 actions)
- [Tickets, orders and payments](#tickets-orders-and-payments) — 28 hooks (26 filters, 2 actions)
- [Templates and theming](#templates-and-theming) — 13 hooks (10 filters, 3 actions)
- [Page builders and loops](#page-builders-and-loops) — 4 hooks (4 filters, 0 actions)
- [Settings](#settings) — 4 hooks (3 filters, 1 actions)
- [REST, admin and JS bridge](#rest-admin-and-js-bridge) — 10 hooks (9 filters, 1 actions)
- [Lifecycle and registration](#lifecycle-and-registration) — 10 hooks (1 filters, 9 actions)

## Alphabetical index

Click any name to jump to its full entry.

| Filter / Action | Filter / Action |
| --- | --- |
| [`eventkoi_`](#eventkoi_) _f_ | [`eventkoi_get_event_start_date_raw`](#eventkoi_get_event_start_date_raw) _f_ |
| [`eventkoi_admin_installed`](#eventkoi_admin_installed) _a_ | [`eventkoi_get_event_status`](#eventkoi_get_event_status) _f_ |
| [`eventkoi_admin_menu_items`](#eventkoi_admin_menu_items) _f_ | [`eventkoi_get_event_tbc`](#eventkoi_get_event_tbc) _f_ |
| [`eventkoi_admin_params`](#eventkoi_admin_params) _f_ | [`eventkoi_get_event_tbc_note`](#eventkoi_get_event_tbc_note) _f_ |
| [`eventkoi_after_calendar_content`](#eventkoi_after_calendar_content) _a_ | [`eventkoi_get_event_thumbnail`](#eventkoi_get_event_thumbnail) _f_ |
| [`eventkoi_after_event_content`](#eventkoi_after_event_content) _a_ | [`eventkoi_get_event_tickets_display_mode`](#eventkoi_get_event_tickets_display_mode) _f_ |
| [`eventkoi_after_events_deleted`](#eventkoi_after_events_deleted) _a_ | [`eventkoi_get_event_tickets_enabled`](#eventkoi_get_event_tickets_enabled) _f_ |
| [`eventkoi_after_events_duplicated`](#eventkoi_after_events_duplicated) _a_ | [`eventkoi_get_event_tickets_terms_conditions`](#eventkoi_get_event_tickets_terms_conditions) _f_ |
| [`eventkoi_after_events_removed`](#eventkoi_after_events_removed) _a_ | [`eventkoi_get_event_timezone`](#eventkoi_get_event_timezone) _f_ |
| [`eventkoi_after_events_restored`](#eventkoi_after_events_restored) _a_ | [`eventkoi_get_event_title`](#eventkoi_get_event_title) _f_ |
| [`eventkoi_after_order_created`](#eventkoi_after_order_created) _a_ | [`eventkoi_get_event_type`](#eventkoi_get_event_type) _f_ |
| [`eventkoi_after_order_updated`](#eventkoi_after_order_updated) _a_ | [`eventkoi_get_event_url`](#eventkoi_get_event_url) _f_ |
| [`eventkoi_after_register_post_type`](#eventkoi_after_register_post_type) _a_ | [`eventkoi_get_event_virtual_url`](#eventkoi_get_event_virtual_url) _f_ |
| [`eventkoi_after_register_taxonomy`](#eventkoi_after_register_taxonomy) _a_ | [`eventkoi_get_footer`](#eventkoi_get_footer) _f_ |
| [`eventkoi_after_update_calendar_meta`](#eventkoi_after_update_calendar_meta) _a_ | [`eventkoi_get_header`](#eventkoi_get_header) _f_ |
| [`eventkoi_after_update_event_meta`](#eventkoi_after_update_event_meta) _a_ | [`eventkoi_get_order_stats`](#eventkoi_get_order_stats) _f_ |
| [`eventkoi_beaver_event_options_limit`](#eventkoi_beaver_event_options_limit) _f_ | [`eventkoi_get_private_api_key`](#eventkoi_get_private_api_key) _f_ |
| [`eventkoi_beaver_route_occurrence_query`](#eventkoi_beaver_route_occurrence_query) _f_ | [`eventkoi_get_settings`](#eventkoi_get_settings) _f_ |
| [`eventkoi_before_calendar_content`](#eventkoi_before_calendar_content) _a_ | [`eventkoi_get_start_date_g`](#eventkoi_get_start_date_g) _f_ |
| [`eventkoi_before_event_content`](#eventkoi_before_event_content) _a_ | [`eventkoi_get_status_title`](#eventkoi_get_status_title) _f_ |
| [`eventkoi_before_save_settings`](#eventkoi_before_save_settings) _a_ | [`eventkoi_get_stripe_currency`](#eventkoi_get_stripe_currency) _f_ |
| [`eventkoi_before_update_calendar_meta`](#eventkoi_before_update_calendar_meta) _a_ | [`eventkoi_get_stripe_webhook_secret`](#eventkoi_get_stripe_webhook_secret) _f_ |
| [`eventkoi_before_update_event_meta`](#eventkoi_before_update_event_meta) _a_ | [`eventkoi_get_summary`](#eventkoi_get_summary) _f_ |
| [`eventkoi_block_live_stripe_on_staging`](#eventkoi_block_live_stripe_on_staging) _f_ | [`eventkoi_get_summary_from_string`](#eventkoi_get_summary_from_string) _f_ |
| [`eventkoi_calendar_display_max_results`](#eventkoi_calendar_display_max_results) _f_ | [`eventkoi_get_template_asset`](#eventkoi_get_template_asset) _f_ |
| [`eventkoi_currency`](#eventkoi_currency) _f_ | [`eventkoi_get_timezone_display`](#eventkoi_get_timezone_display) _f_ |
| [`eventkoi_currency_locale`](#eventkoi_currency_locale) _f_ | [`eventkoi_installed`](#eventkoi_installed) _a_ |
| [`eventkoi_current_theme_support`](#eventkoi_current_theme_support) _f_ | [`eventkoi_live_mode_enabled`](#eventkoi_live_mode_enabled) _f_ |
| [`eventkoi_default_calendar_color`](#eventkoi_default_calendar_color) _f_ | [`eventkoi_locate_template`](#eventkoi_locate_template) _f_ |
| [`eventkoi_divi_event_options_limit`](#eventkoi_divi_event_options_limit) _f_ | [`eventkoi_login_url`](#eventkoi_login_url) _f_ |
| [`eventkoi_event_posts_migrated`](#eventkoi_event_posts_migrated) _a_ | [`eventkoi_loop_default_window_seconds`](#eventkoi_loop_default_window_seconds) _f_ |
| [`eventkoi_event_series_template_args`](#eventkoi_event_series_template_args) _f_ | [`eventkoi_low_stock_threshold`](#eventkoi_low_stock_threshold) _f_ |
| [`eventkoi_event_template_args`](#eventkoi_event_template_args) _f_ | [`eventkoi_max_recurrence_iterations`](#eventkoi_max_recurrence_iterations) _f_ |
| [`eventkoi_field_date_format`](#eventkoi_field_date_format) _f_ | [`eventkoi_max_upload_size_mb`](#eventkoi_max_upload_size_mb) _f_ |
| [`eventkoi_frontend_params`](#eventkoi_frontend_params) _f_ | [`eventkoi_pre_setting_value`](#eventkoi_pre_setting_value) _f_ |
| [`eventkoi_get_calendar_color`](#eventkoi_get_calendar_color) _f_ | [`eventkoi_pre_update_calendar_meta`](#eventkoi_pre_update_calendar_meta) _f_ |
| [`eventkoi_get_calendar_content`](#eventkoi_get_calendar_content) _f_ | [`eventkoi_pre_update_event_meta`](#eventkoi_pre_update_event_meta) _f_ |
| [`eventkoi_get_calendar_count`](#eventkoi_get_calendar_count) _f_ | [`eventkoi_prepare_raw_db_data`](#eventkoi_prepare_raw_db_data) _f_ |
| [`eventkoi_get_calendar_day_start_time`](#eventkoi_get_calendar_day_start_time) _f_ | [`eventkoi_qr_checkin_capability`](#eventkoi_qr_checkin_capability) _f_ |
| [`eventkoi_get_calendar_default_month`](#eventkoi_get_calendar_default_month) _f_ | [`eventkoi_raw_client_ip`](#eventkoi_raw_client_ip) _f_ |
| [`eventkoi_get_calendar_default_year`](#eventkoi_get_calendar_default_year) _f_ | [`eventkoi_refund_email_subject`](#eventkoi_refund_email_subject) _f_ |
| [`eventkoi_get_calendar_display`](#eventkoi_get_calendar_display) _f_ | [`eventkoi_refund_email_tags`](#eventkoi_refund_email_tags) _f_ |
| [`eventkoi_get_calendar_id`](#eventkoi_get_calendar_id) _f_ | [`eventkoi_refund_email_template`](#eventkoi_refund_email_template) _f_ |
| [`eventkoi_get_calendar_list_date_end`](#eventkoi_get_calendar_list_date_end) _f_ | [`eventkoi_register_post_type`](#eventkoi_register_post_type) _a_ |
| [`eventkoi_get_calendar_list_date_start`](#eventkoi_get_calendar_list_date_start) _f_ | [`eventkoi_register_rewrites`](#eventkoi_register_rewrites) _a_ |
| [`eventkoi_get_calendar_list_expand_instances`](#eventkoi_get_calendar_list_expand_instances) _f_ | [`eventkoi_register_taxonomy`](#eventkoi_register_taxonomy) _a_ |
| [`eventkoi_get_calendar_list_load_mode`](#eventkoi_get_calendar_list_load_mode) _f_ | [`eventkoi_rendered_custom_field`](#eventkoi_rendered_custom_field) _f_ |
| [`eventkoi_get_calendar_list_max_results`](#eventkoi_get_calendar_list_max_results) _f_ | [`eventkoi_rendered_custom_field_group`](#eventkoi_rendered_custom_field_group) _f_ |
| [`eventkoi_get_calendar_list_order`](#eventkoi_get_calendar_list_order) _f_ | [`eventkoi_rendered_custom_fields`](#eventkoi_rendered_custom_fields) _f_ |
| [`eventkoi_get_calendar_list_orderby`](#eventkoi_get_calendar_list_orderby) _f_ | [`eventkoi_rendered_event_calendar`](#eventkoi_rendered_event_calendar) _f_ |
| [`eventkoi_get_calendar_list_per_page`](#eventkoi_get_calendar_list_per_page) _f_ | [`eventkoi_rendered_event_calendar_url`](#eventkoi_rendered_event_calendar_url) _f_ |
| [`eventkoi_get_calendar_meta`](#eventkoi_get_calendar_meta) _f_ | [`eventkoi_rendered_event_capacity`](#eventkoi_rendered_event_capacity) _f_ |
| [`eventkoi_get_calendar_name`](#eventkoi_get_calendar_name) _f_ | [`eventkoi_rendered_event_capacity_remaining`](#eventkoi_rendered_event_capacity_remaining) _f_ |
| [`eventkoi_get_calendar_shortcode`](#eventkoi_get_calendar_shortcode) _f_ | [`eventkoi_rendered_event_capacity_sold`](#eventkoi_rendered_event_capacity_sold) _f_ |
| [`eventkoi_get_calendar_slug`](#eventkoi_get_calendar_slug) _f_ | [`eventkoi_rendered_event_date`](#eventkoi_rendered_event_date) _f_ |
| [`eventkoi_get_calendar_startday`](#eventkoi_get_calendar_startday) _f_ | [`eventkoi_rendered_event_date_day`](#eventkoi_rendered_event_date_day) _f_ |
| [`eventkoi_get_calendar_timeframe`](#eventkoi_get_calendar_timeframe) _f_ | [`eventkoi_rendered_event_date_day_name`](#eventkoi_rendered_event_date_day_name) _f_ |
| [`eventkoi_get_calendar_url`](#eventkoi_get_calendar_url) _f_ | [`eventkoi_rendered_event_date_iso`](#eventkoi_rendered_event_date_iso) _f_ |
| [`eventkoi_get_content`](#eventkoi_get_content) _f_ | [`eventkoi_rendered_event_date_month`](#eventkoi_rendered_event_date_month) _f_ |
| [`eventkoi_get_custom_fields`](#eventkoi_get_custom_fields) _f_ | [`eventkoi_rendered_event_date_month_short`](#eventkoi_rendered_event_date_month_short) _f_ |
| [`eventkoi_get_custom_fields_layout`](#eventkoi_get_custom_fields_layout) _f_ | [`eventkoi_rendered_event_date_year`](#eventkoi_rendered_event_date_year) _f_ |
| [`eventkoi_get_custom_fields_state`](#eventkoi_get_custom_fields_state) _f_ | [`eventkoi_rendered_event_datetime`](#eventkoi_rendered_event_datetime) _f_ |
| [`eventkoi_get_default_date_format`](#eventkoi_get_default_date_format) _f_ | [`eventkoi_rendered_event_datetime_with_summary`](#eventkoi_rendered_event_datetime_with_summary) _f_ |
| [`eventkoi_get_default_event_template`](#eventkoi_get_default_event_template) _f_ | [`eventkoi_rendered_event_details`](#eventkoi_rendered_event_details) _f_ |
| [`eventkoi_get_default_template`](#eventkoi_get_default_template) _f_ | [`eventkoi_rendered_event_image_url`](#eventkoi_rendered_event_image_url) _f_ |
| [`eventkoi_get_end_date_g`](#eventkoi_get_end_date_g) _f_ | [`eventkoi_rendered_event_location`](#eventkoi_rendered_event_location) _f_ |
| [`eventkoi_get_event_attendance_mode`](#eventkoi_get_event_attendance_mode) _f_ | [`eventkoi_rendered_event_low_stock`](#eventkoi_rendered_event_low_stock) _f_ |
| [`eventkoi_get_event_calendar`](#eventkoi_get_event_calendar) _f_ | [`eventkoi_rendered_event_rsvp`](#eventkoi_rendered_event_rsvp) _f_ |
| [`eventkoi_get_event_core_status`](#eventkoi_get_event_core_status) _f_ | [`eventkoi_rendered_event_rsvp_capacity`](#eventkoi_rendered_event_rsvp_capacity) _f_ |
| [`eventkoi_get_event_counts`](#eventkoi_get_event_counts) _f_ | [`eventkoi_rendered_event_rsvp_full`](#eventkoi_rendered_event_rsvp_full) _f_ |
| [`eventkoi_get_event_days`](#eventkoi_get_event_days) _f_ | [`eventkoi_rendered_event_rsvp_going`](#eventkoi_rendered_event_rsvp_going) _f_ |
| [`eventkoi_get_event_description`](#eventkoi_get_event_description) _f_ | [`eventkoi_rendered_event_rsvp_remaining`](#eventkoi_rendered_event_rsvp_remaining) _f_ |
| [`eventkoi_get_event_dynamic_tags`](#eventkoi_get_event_dynamic_tags) _f_ | [`eventkoi_rendered_event_sales_end`](#eventkoi_rendered_event_sales_end) _f_ |
| [`eventkoi_get_event_embed_gmap`](#eventkoi_get_event_embed_gmap) _f_ | [`eventkoi_rendered_event_sales_start`](#eventkoi_rendered_event_sales_start) _f_ |
| [`eventkoi_get_event_end_date_iso`](#eventkoi_get_event_end_date_iso) _f_ | [`eventkoi_rendered_event_sold_out`](#eventkoi_rendered_event_sold_out) _f_ |
| [`eventkoi_get_event_end_date_raw`](#eventkoi_get_event_end_date_raw) _f_ | [`eventkoi_rendered_event_ticket_count`](#eventkoi_rendered_event_ticket_count) _f_ |
| [`eventkoi_get_event_gmap_link`](#eventkoi_get_event_gmap_link) _f_ | [`eventkoi_rendered_event_ticket_price_from`](#eventkoi_rendered_event_ticket_price_from) _f_ |
| [`eventkoi_get_event_ical`](#eventkoi_get_event_ical) _f_ | [`eventkoi_rendered_event_ticket_price_range`](#eventkoi_rendered_event_ticket_price_range) _f_ |
| [`eventkoi_get_event_id`](#eventkoi_get_event_id) _f_ | [`eventkoi_rendered_event_ticket_price_to`](#eventkoi_rendered_event_ticket_price_to) _f_ |
| [`eventkoi_get_event_image`](#eventkoi_get_event_image) _f_ | [`eventkoi_rendered_event_ticket_summary`](#eventkoi_rendered_event_ticket_summary) _f_ |
| [`eventkoi_get_event_image_id`](#eventkoi_get_event_image_id) _f_ | [`eventkoi_rendered_event_tickets`](#eventkoi_rendered_event_tickets) _f_ |
| [`eventkoi_get_event_image_thumb`](#eventkoi_get_event_image_thumb) _f_ | [`eventkoi_rendered_event_time`](#eventkoi_rendered_event_time) _f_ |
| [`eventkoi_get_event_latitude`](#eventkoi_get_event_latitude) _f_ | [`eventkoi_rendered_event_timezone`](#eventkoi_rendered_event_timezone) _f_ |
| [`eventkoi_get_event_location`](#eventkoi_get_event_location) _f_ | [`eventkoi_rendered_event_title`](#eventkoi_rendered_event_title) _f_ |
| [`eventkoi_get_event_locations`](#eventkoi_get_event_locations) _f_ | [`eventkoi_rendered_event_type`](#eventkoi_rendered_event_type) _f_ |
| [`eventkoi_get_event_longitude`](#eventkoi_get_event_longitude) _f_ | [`eventkoi_rendered_meta_for_`](#eventkoi_rendered_meta_for_) _f_ |
...
[↑ Back to topics](#topics) · [A-Z index](#alphabetical-index)

## Calendars

_27 filters · 5 actions_  
...
## REST, admin and JS bridge

_9 filters · 1 actions_  
...
_Total: **205 unique hooks** (179 filters, 26 actions) — 178 in both plugins, 27 Pro-only, 0 Lite-only._