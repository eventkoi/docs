...
| Hook | Hook | Hook | Hook |
| --- | --- | --- | --- |
| [`eventkoi_`](#eventkoi_) | [`eventkoi_admin_menu_items`](#eventkoi_admin_menu_items) | [`eventkoi_admin_params`](#eventkoi_admin_params) | [`eventkoi_beaver_event_options_limit`](#eventkoi_beaver_event_options_limit) |
| [`eventkoi_beaver_route_occurrence_query`](#eventkoi_beaver_route_occurrence_query) | [`eventkoi_block_live_stripe_on_staging`](#eventkoi_block_live_stripe_on_staging) | [`eventkoi_calendar_display_max_results`](#eventkoi_calendar_display_max_results) | [`eventkoi_currency`](#eventkoi_currency) |
| [`eventkoi_currency_locale`](#eventkoi_currency_locale) | [`eventkoi_current_theme_support`](#eventkoi_current_theme_support) | [`eventkoi_default_calendar_color`](#eventkoi_default_calendar_color) | [`eventkoi_divi_event_options_limit`](#eventkoi_divi_event_options_limit) |
| [`eventkoi_event_series_template_args`](#eventkoi_event_series_template_args) | [`eventkoi_event_template_args`](#eventkoi_event_template_args) | [`eventkoi_field_date_format`](#eventkoi_field_date_format) | [`eventkoi_frontend_params`](#eventkoi_frontend_params) |
| [`eventkoi_get_calendar_color`](#eventkoi_get_calendar_color) | [`eventkoi_get_calendar_content`](#eventkoi_get_calendar_content) | [`eventkoi_get_calendar_count`](#eventkoi_get_calendar_count) | [`eventkoi_get_calendar_day_start_time`](#eventkoi_get_calendar_day_start_time) |
| [`eventkoi_get_calendar_default_month`](#eventkoi_get_calendar_default_month) | [`eventkoi_get_calendar_default_year`](#eventkoi_get_calendar_default_year) | [`eventkoi_get_calendar_display`](#eventkoi_get_calendar_display) | [`eventkoi_get_calendar_id`](#eventkoi_get_calendar_id) |
| [`eventkoi_get_calendar_list_date_end`](#eventkoi_get_calendar_list_date_end) | [`eventkoi_get_calendar_list_date_start`](#eventkoi_get_calendar_list_date_start) | [`eventkoi_get_calendar_list_expand_instances`](#eventkoi_get_calendar_list_expand_instances) | [`eventkoi_get_calendar_list_load_mode`](#eventkoi_get_calendar_list_load_mode) |
| [`eventkoi_get_calendar_list_max_results`](#eventkoi_get_calendar_list_max_results) | [`eventkoi_get_calendar_list_order`](#eventkoi_get_calendar_list_order) | [`eventkoi_get_calendar_list_orderby`](#eventkoi_get_calendar_list_orderby) | [`eventkoi_get_calendar_list_per_page`](#eventkoi_get_calendar_list_per_page) |
| [`eventkoi_get_calendar_meta`](#eventkoi_get_calendar_meta) | [`eventkoi_get_calendar_name`](#eventkoi_get_calendar_name) | [`eventkoi_get_calendar_shortcode`](#eventkoi_get_calendar_shortcode) | [`eventkoi_get_calendar_slug`](#eventkoi_get_calendar_slug) |
| [`eventkoi_get_calendar_startday`](#eventkoi_get_calendar_startday) | [`eventkoi_get_calendar_timeframe`](#eventkoi_get_calendar_timeframe) | [`eventkoi_get_calendar_url`](#eventkoi_get_calendar_url) | [`eventkoi_get_content`](#eventkoi_get_content) |
| [`eventkoi_get_custom_fields`](#eventkoi_get_custom_fields) | [`eventkoi_get_custom_fields_layout`](#eventkoi_get_custom_fields_layout) | [`eventkoi_get_custom_fields_state`](#eventkoi_get_custom_fields_state) | [`eventkoi_get_default_date_format`](#eventkoi_get_default_date_format) |
| [`eventkoi_get_default_event_template`](#eventkoi_get_default_event_template) | [`eventkoi_get_default_template`](#eventkoi_get_default_template) | [`eventkoi_get_end_date_g`](#eventkoi_get_end_date_g) | [`eventkoi_get_event_attendance_mode`](#eventkoi_get_event_attendance_mode) |
| [`eventkoi_get_event_calendar`](#eventkoi_get_event_calendar) | [`eventkoi_get_event_core_status`](#eventkoi_get_event_core_status) | [`eventkoi_get_event_counts`](#eventkoi_get_event_counts) | [`eventkoi_get_event_days`](#eventkoi_get_event_days) |
| [`eventkoi_get_event_description`](#eventkoi_get_event_description) | [`eventkoi_get_event_dynamic_tags`](#eventkoi_get_event_dynamic_tags) | [`eventkoi_get_event_embed_gmap`](#eventkoi_get_event_embed_gmap) | [`eventkoi_get_event_end_date_iso`](#eventkoi_get_event_end_date_iso) |
| [`eventkoi_get_event_end_date_raw`](#eventkoi_get_event_end_date_raw) | [`eventkoi_get_event_gmap_link`](#eventkoi_get_event_gmap_link) | [`eventkoi_get_event_ical`](#eventkoi_get_event_ical) | [`eventkoi_get_event_id`](#eventkoi_get_event_id) |
| [`eventkoi_get_event_image`](#eventkoi_get_event_image) | [`eventkoi_get_event_image_id`](#eventkoi_get_event_image_id) | [`eventkoi_get_event_image_thumb`](#eventkoi_get_event_image_thumb) | [`eventkoi_get_event_latitude`](#eventkoi_get_event_latitude) |
| [`eventkoi_get_event_location`](#eventkoi_get_event_location) | [`eventkoi_get_event_locations`](#eventkoi_get_event_locations) | [`eventkoi_get_event_longitude`](#eventkoi_get_event_longitude) | [`eventkoi_get_event_meta`](#eventkoi_get_event_meta) |
| [`eventkoi_get_event_post_status`](#eventkoi_get_event_post_status) | [`eventkoi_get_event_recurrence_overrides`](#eventkoi_get_event_recurrence_overrides) | [`eventkoi_get_event_recurrence_rules`](#eventkoi_get_event_recurrence_rules) | [`eventkoi_get_event_rsvp_allow_edit`](#eventkoi_get_event_rsvp_allow_edit) |
| [`eventkoi_get_event_rsvp_allow_guests`](#eventkoi_get_event_rsvp_allow_guests) | [`eventkoi_get_event_rsvp_auto_account`](#eventkoi_get_event_rsvp_auto_account) | [`eventkoi_get_event_rsvp_capacity`](#eventkoi_get_event_rsvp_capacity) | [`eventkoi_get_event_rsvp_enabled`](#eventkoi_get_event_rsvp_enabled) |
| [`eventkoi_get_event_rsvp_max_guests`](#eventkoi_get_event_rsvp_max_guests) | [`eventkoi_get_event_rsvp_sale_end`](#eventkoi_get_event_rsvp_sale_end) | [`eventkoi_get_event_rsvp_sale_start`](#eventkoi_get_event_rsvp_sale_start) | [`eventkoi_get_event_rsvp_show_remaining`](#eventkoi_get_event_rsvp_show_remaining) |
| [`eventkoi_get_event_schema`](#eventkoi_get_event_schema) | [`eventkoi_get_event_series_template`](#eventkoi_get_event_series_template) | [`eventkoi_get_event_standard_type`](#eventkoi_get_event_standard_type) | [`eventkoi_get_event_start_date_iso`](#eventkoi_get_event_start_date_iso) |
| [`eventkoi_get_event_start_date_raw`](#eventkoi_get_event_start_date_raw) | [`eventkoi_get_event_status`](#eventkoi_get_event_status) | [`eventkoi_get_event_tbc`](#eventkoi_get_event_tbc) | [`eventkoi_get_event_tbc_note`](#eventkoi_get_event_tbc_note) |
| [`eventkoi_get_event_thumbnail`](#eventkoi_get_event_thumbnail) | [`eventkoi_get_event_tickets_display_mode`](#eventkoi_get_event_tickets_display_mode) | [`eventkoi_get_event_tickets_enabled`](#eventkoi_get_event_tickets_enabled) | [`eventkoi_get_event_tickets_terms_conditions`](#eventkoi_get_event_tickets_terms_conditions) |
| [`eventkoi_get_event_timezone`](#eventkoi_get_event_timezone) | [`eventkoi_get_event_title`](#eventkoi_get_event_title) | [`eventkoi_get_event_type`](#eventkoi_get_event_type) | [`eventkoi_get_event_url`](#eventkoi_get_event_url) |
| [`eventkoi_get_event_virtual_url`](#eventkoi_get_event_virtual_url) | [`eventkoi_get_footer`](#eventkoi_get_footer) | [`eventkoi_get_header`](#eventkoi_get_header) | [`eventkoi_get_order_stats`](#eventkoi_get_order_stats) |
| [`eventkoi_get_private_api_key`](#eventkoi_get_private_api_key) | [`eventkoi_get_settings`](#eventkoi_get_settings) | [`eventkoi_get_start_date_g`](#eventkoi_get_start_date_g) | [`eventkoi_get_status_title`](#eventkoi_get_status_title) |
| [`eventkoi_get_stripe_currency`](#eventkoi_get_stripe_currency) | [`eventkoi_get_stripe_webhook_secret`](#eventkoi_get_stripe_webhook_secret) | [`eventkoi_get_summary`](#eventkoi_get_summary) | [`eventkoi_get_summary_from_string`](#eventkoi_get_summary_from_string) |
| [`eventkoi_get_template_asset`](#eventkoi_get_template_asset) | [`eventkoi_get_timezone_display`](#eventkoi_get_timezone_display) | [`eventkoi_live_mode_enabled`](#eventkoi_live_mode_enabled) | [`eventkoi_locate_template`](#eventkoi_locate_template) |
| [`eventkoi_login_url`](#eventkoi_login_url) | [`eventkoi_loop_default_window_seconds`](#eventkoi_loop_default_window_seconds) | [`eventkoi_low_stock_threshold`](#eventkoi_low_stock_threshold) | [`eventkoi_max_recurrence_iterations`](#eventkoi_max_recurrence_iterations) |
| [`eventkoi_max_upload_size_mb`](#eventkoi_max_upload_size_mb) | [`eventkoi_pre_setting_value`](#eventkoi_pre_setting_value) | [`eventkoi_pre_update_calendar_meta`](#eventkoi_pre_update_calendar_meta) | [`eventkoi_pre_update_event_meta`](#eventkoi_pre_update_event_meta) |
| [`eventkoi_prepare_raw_db_data`](#eventkoi_prepare_raw_db_data) | [`eventkoi_qr_checkin_capability`](#eventkoi_qr_checkin_capability) | [`eventkoi_raw_client_ip`](#eventkoi_raw_client_ip) | [`eventkoi_refund_email_subject`](#eventkoi_refund_email_subject) |
| [`eventkoi_refund_email_tags`](#eventkoi_refund_email_tags) | [`eventkoi_refund_email_template`](#eventkoi_refund_email_template) | [`eventkoi_rendered_custom_field`](#eventkoi_rendered_custom_field) | [`eventkoi_rendered_custom_field_group`](#eventkoi_rendered_custom_field_group) |
| [`eventkoi_rendered_custom_fields`](#eventkoi_rendered_custom_fields) | [`eventkoi_rendered_event_calendar`](#eventkoi_rendered_event_calendar) | [`eventkoi_rendered_event_calendar_url`](#eventkoi_rendered_event_calendar_url) | [`eventkoi_rendered_event_capacity`](#eventkoi_rendered_event_capacity) |
| [`eventkoi_rendered_event_capacity_remaining`](#eventkoi_rendered_event_capacity_remaining) | [`eventkoi_rendered_event_capacity_sold`](#eventkoi_rendered_event_capacity_sold) | [`eventkoi_rendered_event_date`](#eventkoi_rendered_event_date) | [`eventkoi_rendered_event_date_day`](#eventkoi_rendered_event_date_day) |
| [`eventkoi_rendered_event_date_day_name`](#eventkoi_rendered_event_date_day_name) | [`eventkoi_rendered_event_date_iso`](#eventkoi_rendered_event_date_iso) | [`eventkoi_rendered_event_date_month`](#eventkoi_rendered_event_date_month) | [`eventkoi_rendered_event_date_month_short`](#eventkoi_rendered_event_date_month_short) |
| [`eventkoi_rendered_event_date_year`](#eventkoi_rendered_event_date_year) | [`eventkoi_rendered_event_datetime`](#eventkoi_rendered_event_datetime) | [`eventkoi_rendered_event_datetime_with_summary`](#eventkoi_rendered_event_datetime_with_summary) | [`eventkoi_rendered_event_details`](#eventkoi_rendered_event_details) |
| [`eventkoi_rendered_event_image_url`](#eventkoi_rendered_event_image_url) | [`eventkoi_rendered_event_location`](#eventkoi_rendered_event_location) | [`eventkoi_rendered_event_low_stock`](#eventkoi_rendered_event_low_stock) | [`eventkoi_rendered_event_rsvp`](#eventkoi_rendered_event_rsvp) |
| [`eventkoi_rendered_event_rsvp_capacity`](#eventkoi_rendered_event_rsvp_capacity) | [`eventkoi_rendered_event_rsvp_full`](#eventkoi_rendered_event_rsvp_full) | [`eventkoi_rendered_event_rsvp_going`](#eventkoi_rendered_event_rsvp_going) | [`eventkoi_rendered_event_rsvp_remaining`](#eventkoi_rendered_event_rsvp_remaining) |
| [`eventkoi_rendered_event_sales_end`](#eventkoi_rendered_event_sales_end) | [`eventkoi_rendered_event_sales_start`](#eventkoi_rendered_event_sales_start) | [`eventkoi_rendered_event_sold_out`](#eventkoi_rendered_event_sold_out) | [`eventkoi_rendered_event_ticket_count`](#eventkoi_rendered_event_ticket_count) |
| [`eventkoi_rendered_event_ticket_price_from`](#eventkoi_rendered_event_ticket_price_from) | [`eventkoi_rendered_event_ticket_price_range`](#eventkoi_rendered_event_ticket_price_range) | [`eventkoi_rendered_event_ticket_price_to`](#eventkoi_rendered_event_ticket_price_to) | [`eventkoi_rendered_event_ticket_summary`](#eventkoi_rendered_event_ticket_summary) |
| [`eventkoi_rendered_event_tickets`](#eventkoi_rendered_event_tickets) | [`eventkoi_rendered_event_time`](#eventkoi_rendered_event_time) | [`eventkoi_rendered_event_timezone`](#eventkoi_rendered_event_timezone) | [`eventkoi_rendered_event_title`](#eventkoi_rendered_event_title) |
| [`eventkoi_rendered_event_type`](#eventkoi_rendered_event_type) | [`eventkoi_rendered_meta_for_`](#eventkoi_rendered_meta_for_) | [`eventkoi_rsvp_email_subject`](#eventkoi_rsvp_email_subject) | [`eventkoi_rsvp_email_tags`](#eventkoi_rsvp_email_tags) |
| [`eventkoi_rsvp_email_template`](#eventkoi_rsvp_email_template) | [`eventkoi_rsvp_qr_code`](#eventkoi_rsvp_qr_code) | [`eventkoi_rsvp_qr_url`](#eventkoi_rsvp_qr_url) | [`eventkoi_set_settings`](#eventkoi_set_settings) |
| [`eventkoi_taxonomy_objects_event_cal`](#eventkoi_taxonomy_objects_event_cal) | [`eventkoi_ticket_email_subject`](#eventkoi_ticket_email_subject) | [`eventkoi_ticket_email_tags`](#eventkoi_ticket_email_tags) | [`eventkoi_ticket_email_template`](#eventkoi_ticket_email_template) |
| [`eventkoi_ticket_qr_url`](#eventkoi_ticket_qr_url) | [`eventkoi_timezone`](#eventkoi_timezone) | [`eventkoi_update_event_meta`](#eventkoi_update_event_meta) |

## All actions (alphabetical)

| Hook | Hook | Hook | Hook |
| --- | --- | --- | --- |
| [`eventkoi_admin_installed`](#eventkoi_admin_installed) | [`eventkoi_after_calendar_content`](#eventkoi_after_calendar_content) | [`eventkoi_after_event_content`](#eventkoi_after_event_content) | [`eventkoi_after_events_deleted`](#eventkoi_after_events_deleted) |
| [`eventkoi_after_events_duplicated`](#eventkoi_after_events_duplicated) | [`eventkoi_after_events_removed`](#eventkoi_after_events_removed) | [`eventkoi_after_events_restored`](#eventkoi_after_events_restored) | [`eventkoi_after_order_created`](#eventkoi_after_order_created) |
| [`eventkoi_after_order_updated`](#eventkoi_after_order_updated) | [`eventkoi_after_register_post_type`](#eventkoi_after_register_post_type) | [`eventkoi_after_register_taxonomy`](#eventkoi_after_register_taxonomy) | [`eventkoi_after_update_calendar_meta`](#eventkoi_after_update_calendar_meta) |
| [`eventkoi_after_update_event_meta`](#eventkoi_after_update_event_meta) | [`eventkoi_before_calendar_content`](#eventkoi_before_calendar_content) | [`eventkoi_before_event_content`](#eventkoi_before_event_content) | [`eventkoi_before_save_settings`](#eventkoi_before_save_settings) |
| [`eventkoi_before_update_calendar_meta`](#eventkoi_before_update_calendar_meta) | [`eventkoi_before_update_event_meta`](#eventkoi_before_update_event_meta) | [`eventkoi_event_posts_migrated`](#eventkoi_event_posts_migrated) | [`eventkoi_installed`](#eventkoi_installed) |
| [`eventkoi_register_post_type`](#eventkoi_register_post_type) | [`eventkoi_register_rewrites`](#eventkoi_register_rewrites) | [`eventkoi_register_taxonomy`](#eventkoi_register_taxonomy) | [`eventkoi_single_calendar_template`](#eventkoi_single_calendar_template) |
| [`eventkoi_single_event_template`](#eventkoi_single_event_template) | [`eventkoi_updated`](#eventkoi_updated) |
